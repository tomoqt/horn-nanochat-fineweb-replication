...
PLAN_JSON="${PLAN_JSON:-${SCRIPT_DIR}/token_horizon_5000_steps_512_2048.json}"
ROOT_OUTDIR="${ROOT_OUTDIR:-${REPO_ROOT}/scaling_runs/horizon_5000_steps_512_2048}"
...
PLOT_PNG="${PLOT_PNG:-${PLOTS_OUTDIR}/horizon_5000_steps_512_2048_bars.png}"
...
echo "[5000-followup] plan=${PLAN_JSON}"
echo "[5000-followup] root_outdir=${ROOT_OUTDIR}"
echo "[5000-followup] summary_json=${SUMMARY_JSON}"
echo "[5000-followup] plot_png=${PLOT_PNG}"
